...
public class BoardUtils {
    ...
    public static final boolean[] C_COLUMN = initColumn(2);
    public static final boolean[] D_COLUMN = initColumn(3);
    public static final boolean[] E_COLUMN = initColumn(4);
    public static final boolean[] F_COLUMN = initColumn(5);
